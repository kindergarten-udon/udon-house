...
const Favorite = ({ userId }) => {
  ...
  return (
    <div className="my-20">
      ...
      <ReactPaginate previousLabel={"<"} nextLabel={">"} pageCount={Math.ceil(favoriteList.length / perPage)} onPageChange={handlePageClick} containerClassName={"pagination"} activeClassName={"active"} />
    </div>
  );
};
