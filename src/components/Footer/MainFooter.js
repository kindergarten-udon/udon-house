...
const MainHeader = () => {
  return (
    <div className="h-screen w-full lg:text-[clamp(12px,1.3vw,16px)] text-base bg-bg-gray-color">
      <div className="h-[30vh] bg-main-color rounded-b-[30px]"></div>
      <div className="w-full h-[70vh] lg:p-[clamp(32px,4%,60px)] px-[32px] py-[48px]">
