...
const FirstMain = () => {
  return (
    <div className="relative w-full h-screen snap-center">
      ...
      <h1 className="absolute left-1/2 top-1/3 lg:text-4xl leading-loose w-[100vw] max-sm:px-2 text-3xl font-bold text-white -translate-x-1/2 -translate-y-1/2 ">
      ...
      <Link
        to="/map"
        type="button"
        className="box-border absolute max-sm:w-[200px] max-sm:h-[40px] max-sm:py-3 max-sm:px-0 py-4 px-20   bottom-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 cursor-pointer text-sm lg:text-base bg-white rounded-xl font-bold"
      >
        어린이집 정보 찾기
      </Link>
