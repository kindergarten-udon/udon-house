...
const ThirdMain = () => {
  ...
  return (
    <div className="start3 w-screen relative bg-main-color h-screen snap-center">
      ...
      <img className="absolute gsap3 opacity-0 animate-bounce w-[15vw] max-w-[100px] lg:w-[10vw] lg:max-w-[150px] right-[20%] bottom-[63%] max-sm:bottom-[75%] lg:bottom-[57%] lg:right-[25%]" src="/main_join_bird.png" />
