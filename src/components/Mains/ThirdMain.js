  ...
  return (
    <div className="test2 w-full relative bg-main-color h-screen snap-center ">
      ...
      <div className="flex w-full -left-[100px] flex-col items-center absolute top-1/3 lg:flex-row px-[160px] ">
        <div className="test3 opacity-0 w-full flex flex-col  bg-btn-green-color rounded-2xl lg:w-full ">
          <img src="/notification1.png" alt="" />
          <div className="bg-white h-8 rounded-b-2xl">공지사항</div>
        </div>
        <div className="test3 opacity-0 hidden w-full bg-pink-color rounded-2xl my-10 lg:mx-10 lg:w-full lg:block">
          <img src="/notification2.png" alt="" />
          <div className="bg-white h-8 rounded-b-2xl">공지사항</div>
        </div>
        <div className="test3 opacity-0 hidden  w-1/2 bg-blue-color rounded-2xl lg:w-full lg:block">
