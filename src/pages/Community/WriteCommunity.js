  ...
  return (
    <>
      ...
      <div className="container w-screen min-w-full text-center lg:px-[7vw] px-[10vw] pt-5 mt-5 bg-gray-100">
        ...
        <div>
          <button className="mr-3 lg:mr-5 text-sm lg:text-base bg-white px-9 lg:px-12 py-2 border border-slate-700 rounded-3xl">취소</button>
          <button className="ml-3 lg:ml-5 text-sm lg:text-base text-white font-bold bg-btn-green-color px-9 lg:px-12 py-2 border rounded-3xl mb-10">작성</button>
        </div>
      </div>
      <CancelButton />
      <WriteButton />
