            ...
            <figure className="px-[5vw] lg:px-0 relative">
              <div className="flex flex-col">
                ...
                <figcaption className="mt-5 text-lg block">
                  <span className="text-2xl">이주형</span>
                  <p className="bg-[#282A35]">
            ...
            <figure className="px-[5vw] lg:px-0 relative">
              <div className="flex flex-col">
                ...
                <figcaption className="mt-5 text-lg ">
                  <span className="text-2xl">유하리</span>
                  <p className="bg-[#282A35]">
          ...
          <div>
            <figure className="px-[5vw] lg:px-0 relative">
              <div className="flex flex-col">
                ...
                <figcaption className="mt-5 text-lg">
                  <span className="text-2xl">장재우</span>
                  <p className="bg-[#282A35]">
          ...
          <div>
            <figure className="px-[5vw] lg:px-0 relative">
              <div className="flex flex-col">
                ...
                <figcaption className="mt-5 text-lg">
                  <span className="text-2xl">조윤호</span>
                  <p className="bg-[#282A35]">
          ...
          <div>
            <figure className="px-[5vw] lg:px-0 relative">
              <div className="flex flex-col">
                ...
                <figcaption className="mt-5 text-lg">
                  <span className="text-2xl">김수민</span>
